...
<body>
  ...
  <div class="container">
    ...
    <div id="customer-form">
      <button onclick="toggleModal()"><i class="fa fa-plus" aria-hidden="true"></i> Add New Team</button>
    </div>
    ...
    <table id="customer-table">
      ...
      <tbody>
        ...
        <?php include "backend/display_team.php"; ?>
  ...
  <script src="scripts/add_team.js" charset="UTF-8"></script>
  <script src="scripts/filter_table.js" charset="UTF-8"></script>
