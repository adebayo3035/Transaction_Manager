...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        ...
        //     $query = "SELECT available_quantity FROM food WHERE food_id = ?";
        ...
        //         echo json_encode(["success" => false, "message" => "The requested quantity for food ID $food_id is not available. Available quantity is: $available_quantity"]);
        //         $conn->rollback();
        //         exit();
        //     }
        // }
