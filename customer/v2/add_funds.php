...
//todos
// -- add amount that was topped up into revenue, transaction, customer_transaction <table>
// -- check why data is not inserting into transaction table during wallet funding
// -- add token generation to under self service module
// -- perfect outstanding Debt payment under wallet funding</table>


// fix issue on customeer_transactions and repayment_history to insert correct amount during repayment(the amount that's being paid at the moment)


// todo on tuesday 7th of Jan 2025
// fix issue with negative remaining_balance column on credit_orders table when making payments for late over due credit orders
// create a revenue type_id for late credit order payment
// seperate credit order repayment from late payment across all tables affected.

// tO DO ON THURSDAY ON 9/01/2025
// Insert Late Payment fee Into transactions table to log late payment fee