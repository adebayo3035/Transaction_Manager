...
<body>
    <div class="dashboard">
        ...
        <div class="order-form-container">
            ...
            <div id="packControls">
                <label for="packName">Enter Number of Packs:</label>
                <input type="number" id="packName" placeholder="Enter Number of Packs" min = "1">

                <label for="packQuantity">Quantity:</label>
                <input type="number" id="packQuantity" min="1" value="1">

                <button id="createPackButton">Create Pack</button>
            </div>
