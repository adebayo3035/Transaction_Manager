...
<?php include ('../customerNavBar.php'); ?>
  ...
  <section class="hero">
    <div class="hero-content">
      ...
      <a href="dashboard.php" class="btn">Explore Menu</a>
    </div>
  ...
  <section id="about" class="about">
    <h2>About Us</h2>
    <p id="aboutText">
        Welcome to KataKara Food Vending, your go-to destination for delicious and fresh food delivered straight to your
        ...
        Thank you for choosing KataKara. We look forward to serving you and making every meal a memorable one!
    </p>
    <a id="readMoreLink" href="javascript:void(0);" onclick="toggleReadMore()">Read More</a>
</section>
